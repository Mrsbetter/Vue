<template>
  <el-form ref="form" :model="form" label-width="180px">
    ...
    <el-form-item :label="$t('account.pageSetupContent.navigationMode')">
      <el-color-picker v-model="navigationMode" show-alpha size="mini"></el-color-picker>
    </el-form-item>
    <el-form-item :label="$t('account.pageSetupContent.contentArea')">
      <el-col :span="6">
        <el-select v-model="languages" :placeholder="$t('account.pageSetupContent.language')" size="mini"  @change="handleSetLanguage" clearable>

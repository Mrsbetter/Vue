<template>
  <el-form ref="form" :model="form" label-width="180px">
    <el-form-item :label="$t('account.pageSetupContent.styleSettings')">
      <el-color-picker v-model="styleSettings" show-alpha size="mini"></el-color-picker>
    </el-form-item>
    ...
    <el-form-item :label="$t('account.pageSetupContent.navigationMode')">
      <el-radio-group v-model="navigationMode" size="small">
        <el-radio label="lt" border>
          左上
        </el-radio>
        <el-radio label="rt" border>
          右上
        </el-radio>
        <el-radio label="l" border>
          左
        </el-radio>
        <el-radio label="t" border>
          上
        </el-radio>
        <el-radio label="r" border>
          右
        </el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item :label="$t('account.pageSetupContent.contentArea')">
      <el-col :span="6">
        <el-select v-model="language" :placeholder="$t('account.pageSetupContent.language')" size="mini" clearable @change="handleSetLanguage">

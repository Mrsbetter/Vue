  ...
  <el-form ref="form" :model="form" label-width="180px">
    <el-form-item :label="$t('account.pageSetupContent.styleSettings')">
      <el-radio-group v-model="navigationMode" size="small">
        <el-radio label="dark" border>暗色</el-radio>
        <el-radio label="light" border>亮色</el-radio>
      </el-radio-group>
    </el-form-item>
    ...
    <el-form-item :label="$t('account.pageSetupContent.contentArea')">
      <el-col :span="6">
        <el-select v-model="language" :placeholder="$t('account.pageSetupContent.language')" size="mini">
